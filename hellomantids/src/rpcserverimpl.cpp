...
bool RPCServerImpl::callbackOnRPCConnect(void *, Network::Streams::StreamSocket *sock, const char * remoteAddr, bool secure)
{
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    //
    Globals::getAppLog()->log0(__func__,Logs::LEVEL_INFO, "Incomming %sRPC connection from (IP=%s,CN=%s,COMPONENT=%s)", secure?"secure ":"", remoteAddr, tlsSock->getTLSPeerCN().c_str(), sComponent.c_str());
...
{
    Globals::getAppLog()->log1(__func__,remotePairIPAddr,Logs::LEVEL_ERR,  "Incomming RPC Client TLS initialization Failed...");
