...
private:
     ...
     */
    static bool _callbackOnInitFailed(void *, Mantids::Network::Sockets::Socket_StreamBase *, const char *, bool);
    /**
     ...
     */
    static void _callbackOnTimeOut(void *, Mantids::Network::Sockets::Socket_StreamBase *, const char *, bool);
